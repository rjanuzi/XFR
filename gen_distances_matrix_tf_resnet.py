...
from fr.tf_resnet_descriptor import gen_tf_resnet_faceparts_distances
from util._telegram import send_simple_message

logging.basicConfig(
    filename="gen_distances_matrix_tf_resenet.log",
...
if __name__ == "__main__":
    try:
        ...
        send_simple_message("Error generating TF RESNET distances matrix.")
